...
const CreateUserForm: React.FC<CreateUserFormProps> = ({
  ...
  return (
    <div>
      ...
      <div className="flex flex-row justify-end w-full bg-brandgray-700 px-8">
        <div className="py-3 w-28 sm:flex sm:flex-row-reverse">
          ...
          <button
            onClick={onClose}
            type="button"
            className="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-brandgray-600 text-base font-medium text-white hover:bg-brandgray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:ml-3 sm:w-full sm:text-sm"
          >
            Cancel
          </button>
        </div>
